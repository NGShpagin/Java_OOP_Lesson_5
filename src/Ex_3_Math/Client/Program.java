...
//        Shape shape2 = Rectangle.create(2, 3, "Rectangle_1");
//        Shape shape3 = Circle.create(4, "Circle_2");
//        Shape shape4 = Rectangle.create(5, 6, "Rectangle_2");
//        Shape shape5 = Rectangle.create(7, 8, "Rectangle_3");
//        Shape shape6 = Circle.create(9, "Circle_3");
//
